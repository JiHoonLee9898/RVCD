...
class halc_assistant:
    def __init__(
        ...
        # 변경됨! not_rvcd_llava, not_rvcd_mini_gpt4, not_rvcd_mplug_owl2
        if self.model_backbone == "minigpt4" or self.model_backbone == "llava-1.5" or \
            self.model_backbone == 'not_rvcd_mini_gpt4' or self.model_backbone == 'not_rvcd_llava':
